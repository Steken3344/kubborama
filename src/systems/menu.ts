...
export class MenuSystem extends createSystem({
  ...
  init(): void {
    ...
    this.wireButton('avatar-color-button', () => {
      // MP3b: cycle the palette — same one-button pattern as the rest of
      // this tab. The OTHER player sees the color; it also tints your
      // side of the HUD score.
